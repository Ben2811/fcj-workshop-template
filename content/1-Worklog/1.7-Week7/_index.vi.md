...
* Tìm hiểu các giải pháp lưu trữ hybrid và có khả năng mở rộng: AWS Storage Gateway và Amazon FSx.
* Xây dựng môi trường Data Lake trên AWS.
* Thiết kế mô hình dữ liệu NoSQL nâng cao với Amazon DynamoDB.
* Tìm hiểu chiến lược tối ưu chi phí với Savings Plans và Reserved Instances.
* Tham gia FCAJ Community Day để mở rộng kiến thức kỹ thuật và định hướng nghề nghiệp.
...
* Học cách lưu trữ dữ liệu gần như không giới hạn trên AWS bằng File Storage Gateway.
* Triển khai kho lưu trữ dùng chung cho Windows bằng Amazon FSx.
* Xây dựng môi trường Data Lake trên AWS.
