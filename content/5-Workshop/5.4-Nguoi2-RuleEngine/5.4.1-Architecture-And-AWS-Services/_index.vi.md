...
Trường `Weeks` là output chính của chức năng bạn ấy phụ trách. Nó chứa cấu trúc tuần, ngày và bài tập trả về cho frontend.
...
Với phần của bạn ấy, các log group quan trọng là:
...
Đến bước này, phần AWS trong vai trò của bạn ấy đã được xác minh:
