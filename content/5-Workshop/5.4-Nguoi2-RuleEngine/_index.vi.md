...
Đây là phần việc của Trần Anh Tài trong dự án PeriodIQ. Bạn ấy phụ trách luồng sinh giáo án tập luyện, từ dữ liệu người dùng nhập vào đến giáo án 4 tuần được tạo ra.

Phạm vi của bạn ấy sử dụng 3 dịch vụ AWS chính:
...
Ngoài ra, bạn ấy triển khai **luồng sản phẩm Workout Plan** để user nhập thông số tập luyện, tạo giáo án, xem progression theo tuần và xem mục tiêu từng bài như set, rep, RPE, thời gian nghỉ và mức tạ.
