---
title : "Le Huu Duy Hoang - Progress & Async Notification"
date : 2024-01-01
weight : 5
chapter : false
pre : " <b> 5.5. </b> "
...
This was Le Huu Duy Hoang's role in the **PeriodIQ** project. His core responsibility was handling all **Asynchronous Data Flows** and **User Progression Tracking** logic, from the moment users finish their workout to the moment the system sends notifications.

Below are the 3 core AWS services he set up and integrated:
...
According to the team assignment, he heavily focused on developing the **Backend (.NET 10)** for these workflows:
