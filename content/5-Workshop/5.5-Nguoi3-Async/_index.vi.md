...
Đây là vai trò của Lê Hữu Duy Hoàng trong dự án **PeriodIQ**. Trách nhiệm của bạn ấy là xử lý toàn bộ luồng dữ liệu **Bất đồng bộ (Asynchronous)** và **Theo dõi tiến trình tập luyện (Progression Tracking)** của người dùng, từ lúc họ hoàn thành buổi tập cho đến khi hệ thống gửi thông báo.

Dưới đây là 3 dịch vụ AWS cốt lõi mà bạn ấy đã thiết lập và tích hợp:
...
Theo sự phân công, bạn ấy tập trung mạnh vào phát triển **Backend (.NET 10)** cho các luồng xử lý này:
